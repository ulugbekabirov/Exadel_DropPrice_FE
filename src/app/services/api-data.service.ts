...
export class ApiDataService {
  ...
  updateIsSavedDiscount(options): Observable<any> {
    return this.http.put(`${environment.webApiUrl}${GET_DISCOUNTS_ENDPOINT}/id/${PUT_IS_SAVED_DISCOUNTS_ENDPOINT}`, options);
  }
